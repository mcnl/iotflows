...
public class pesquisaDados extends AsyncTask<Void, Void, Void> {
    String pesquisa = MainActivity.searchedString;
    String aux = "";
    String dado = "";
    ...
    protected Void doInBackground(Void... voids) {
        try{
            ...
            for(int i = 0; i < JA.length(); i++){
                ...
                aux = aux + JO.get("title");
                if(aux.toLowerCase().contains(pesquisa.toLowerCase())) {
            ...
            if(dadoparseados==""){
                dadoparseados = "Nenhum resultado encontrado para '" + pesquisa + "'";
            }
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        pesquisaActivity.data.setText(dadoparseados);
        pesquisaActivity.res.setText("Resultados para '" + pesquisa + "'");
